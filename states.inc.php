...
$machinestates = array(
    ...
    11 => array(
        ...
        "transitions" => array(  "calculateScore" => 7, "coatOfArms" => 8, "zombiePass" => 50 )
    ), 
    ...
    8 => array(
        "name" => "coatOfArms",
        "description" => clienttranslate('${actplayer} must place a special facade tile, take an ability tile, or flip over their used ability tiles.'),
